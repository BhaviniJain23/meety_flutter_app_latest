        ...
        body: FutureBuilder(
            ...
            builder: (context, snapshot) {
              return SmartRefresher(
                ...
                child:
                    Container(), /*Selector<LoginUserProvider, User?>(
                      ...
                      children: [
                        SingleChildScrollView(
                          child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
                              if (loginUserVal?.pastSubscription != null) ...[
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color: lightBlue.toMaterialColor.shade50,
                                        boxShadow: [
                                          BoxShadow(
                              ...
                              if (loginUserVal?.isProfileVerifiedStatus == "1" &&
                                  loginUserVal?.profileVerificationReason ==
                                      "2") ...[
                                Padding(
                                  padding: const EdgeInsets.symmetric(
                              ...
                              Row(
                                ...
                                children: [
                                  Container(
                                    height: ResponsiveDesign.height(115, context),
                                      ...
                                      children: [
                                        Selector<LoginUserProvider,
                                          ...
                                          selector: (context, provider) => Tuple2(
                                              ...
                                              provider.profileCompletePercentage),
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              if (loginUserVal.isProfileVerified ==
                                                      '1' ||
                                                  loginUserVal
                                          ...
                                          SizedBox(
                                            height:
                                                ResponsiveDesign.height(3, context),
                                          ),
                                              ...
                                              style: TextStyle(
                                                  ...
                                                  fontSize:
                                                      ResponsiveDesign.fontSize(
                                                          14, context),
                                                  fontWeight: FontWeight.w500)),
                                          loginUserVal.occupation!.isNotEmpty
                                              ? Text(
                                          ...
                                          SizedBox(
                                            height:
                                                ResponsiveDesign.height(5, context),
                                          ),
                                          Container(
                                            margin: const EdgeInsets.only(top: 0),
                                            width:
                                                ResponsiveDesign.width(75, context),
                                            height: ResponsiveDesign.height(
                                                30, context),
                                            decoration: BoxDecoration(
                                                borderRadius:
                              ...
                              loginUserVal.about!.isNotEmpty
                                  ? Padding(
                                      padding:
                                          ResponsiveDesign.only(context, left: 25),
                                      child: titleDescription("About:",
                                          loginUserVal.about ?? '', context),
                                    )
                                  : const SizedBox.shrink()
                            ],
                          ),
                        ...
                        Expanded(
                          ...
                          color: white.toMaterialColor.shade600.withOpacity(0.9),
                          padding: const EdgeInsets.symmetric(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    width: ResponsiveDesign.width(375, context),
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: const DecorationImage(
                                            image: AssetImage(Assets.moreMessage),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            Utils.addonsMessage(
                                                ConstantList.messageHeadingCaption),
                                            style: TextStyle(
                                                fontSize: ResponsiveDesign.fontSize(
                                                    12, context)),
                                          ),
                                ...
                                if (loginUserVal.pastSubscription?.planId !=
                                    "3") ...[
                                  InkWell(
                                    onTap: () {
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          ...
                                          image: const DecorationImage(
                                              image: AssetImage(Assets.visitorIcon),
                                              alignment: Alignment.centerLeft)),
                                      child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                  ...
                                  Expanded(
                                    child: Center(
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          height:
                                              ResponsiveDesign.height(250, context),
                                          width:
                                              ResponsiveDesign.width(375, context),
                                          decoration: BoxDecoration(
                                              image: const DecorationImage(
                                                  image: AssetImage(
                                                      Assets.dummyVerified),
                                                  fit: BoxFit.fill,
