...
class ConstantList {
  ...
  static List<String> interestList = [
    ...
    "⛺ Camping & Nature Trips",
    "🌿 Health & Wellness",
    "🍷 Wine Tasting & Winemaking",
    "🍻 Beer Brewing & Craft Beers",
    "🎟️ Vintage Collecting",
    "📱 Online Culture & Memes",
    "📚 Language Learning & Linguistics",
    "🕰️ Historical Reenactment",
    "🏍️ Motorcycle Riding",
    ...
    "⛰️ Outdoor Adventurer and Hiker",
    "📖 Bookworm and Literature Lover",
    "🎶 Indie Music & Live Concerts",
    "🍔 Foodie & Culinary Explorer",
    "🤝 Volunteer & Community Activist",
    "🎮 Gaming & eSports Fanatic",
    "🐾 Pet Lover & Animal Advocate",
    "🎨 Artistic & Creative Soul",
    "✈️ Traveler & Wanderlust Seeker",
    "📱 Tech Geek & Gadget Enthusiast",
    "💪 Fitness Junkie & Gym Goer",
    "🧵 DIY & Craft Enthusiast",
    "🕰️ Vintage Collector & Nostalgia Lover",
    "🌐 Language Enthusiast & Polyglot",
    "🌍 Social Justice Advocate",
    "🎬 Film Buff & Movie Aficionado",
    "📸 Nature Photographer",
    "👠 Fashion & Style Enthusiast",
    "🏈 Sports Fan & Game Day Cheerleader",
    "🏞️ Nature Explore",
    "🎥 Film Connoisseur",
    "🍽️ Culinary Adventurer",
    ...
    "💪 Fitness & Wellness",
    "🕰️ Vintage Collector",
    "📚 Linguist & Language Lover",
    "🌿 Environmental Steward",
    "👗 Fashion and Style Aficionado",
    "⚽ Sports Enthusiast",
    "📷 Art of Photography",
    "📚 Book Nerd",
    ...
    "📸 Photojournalism & Social Issues",
    "🏛️ Ancient History & Archaeology",
